...
import { CircularProgressbarWithChildren } from
    ...
    >
     {current? (
      <div className="w-[102px] h-[102px] relative">
       ...
       font-bold uppercase text-purple-500 bg-white rounded-xl 
       animate-bounce tracking-wide z-10">
        Start
        <div 
         className="absolute left-1/2 -bottom-2 w-0 h-0 border-x-8
         border-x-transparent border-t-8 transform -translate-x"
        />
       </div>
