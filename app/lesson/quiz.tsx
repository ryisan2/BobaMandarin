...
if(initialPercentage === 100) {
  ...
  const [status, setStatus] = useState<"correct" | "wrong" | "unanswered">(
    "unanswered"
  );
      ...
      <>
        ...
        >
          ...
          <Image
            ...
            width={250}
          />
          <h1 className="font-bold lg:text-3xl text-xl text-purple-700">
    ...
    <>
      ...
      <div className="flex-1">
        <div className="h-full flex items-center justify-center">
          <div
            className="lg:min-h-[350px] lg:w-[600px]
                    w-full px-6 lg:px-0 flex flex-col gap-y-12"
          >
            <h1
